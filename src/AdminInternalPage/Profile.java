...
public class Profile extends javax.swing.JFrame {
    ...
    public Profile() {
        initComponents();
        loadSessionInfo(); // populate all labels from the active session
    }
    ...
    private void initComponents() {
        ...
        listadmin.setBackground(new java.awt.Color(255, 255, 255));
        ...
        role.setText("Role :");
        staffpanel.add(role, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, -1, -1));

        lastname.setFont(new java.awt.Font("Bahnschrift", 1, 18)); // NOI18N
        lastname.setForeground(new java.awt.Color(239, 234, 234));
        lastname.setText("Last Name :");
        staffpanel.add(lastname, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, -1, -1));
        ...
        staffpanel.add(yourid, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, -1, -1));

        lblid.setFont(new java.awt.Font("Bahnschrift", 1, 18)); // NOI18N
        lblid.setForeground(new java.awt.Color(239, 234, 234));
        lblid.setText("id");
        staffpanel.add(lblid, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 150, -1));
        ...
        staffpanel.add(lblfirstname, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, 150, 20));
        ...
        staffpanel.add(lbllastname, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, 180, 20));

        firstname.setFont(new java.awt.Font("Bahnschrift", 1, 18)); // NOI18N
        firstname.setForeground(new java.awt.Color(239, 234, 234));
        firstname.setText("First Name :");
        staffpanel.add(firstname, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, -1, -1));
        ...
        staffpanel.add(lblrole, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, 90, 20));

        email.setFont(new java.awt.Font("Bahnschrift", 1, 18)); // NOI18N
        email.setForeground(new java.awt.Color(239, 234, 234));
        email.setText("Email :");
        staffpanel.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, -1, -1));

        lblemail.setFont(new java.awt.Font("Bahnschrift", 1, 18)); // NOI18N
        lblemail.setForeground(new java.awt.Color(239, 234, 234));
        lblemail.setText("email");
        staffpanel.add(lblemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 220, 20));
        ...
        listadmin.add(staffpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 510, 330));
     ...
     // ── Populate all profile labels from the active Session ──────────────────
    private void loadSessionInfo() {
        ...
        if (session.isLoggedIn()) {
            ...
            // Fallback — no active session (should not happen in normal flow)
            lblid.setText("—");
    ...
    private void exitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exitMouseClicked
     Session session = Session.getInstance();
        if ("Admin".equalsIgnoreCase(session.getUserType())) {
