...
public class AvailableEmployee extends javax.swing.JFrame {
    ...
    public AvailableEmployee() {
        ...
        reporttypecombobox.addActionListener(e -> filterAvailable());
        filterAvailable();

        searchfield.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            public void insertUpdate(javax.swing.event.DocumentEvent e)  { filterAvailable(); }
            public void removeUpdate(javax.swing.event.DocumentEvent e)  { filterAvailable(); }
            public void changedUpdate(javax.swing.event.DocumentEvent e) { filterAvailable(); }
        });
    ...
    private void filterAvailable() {
        ...
        if (kw.equals("Search Cleaners")) kw = "";

        String statusClause;
        switch (selected) {
            case "Available Only": statusClause = " AND work_status = 'Available'"; break;
            case "Busy Only":      statusClause = " AND work_status = 'Busy'"; break;
            case "Off Duty Only":  statusClause = " AND work_status = 'Off Duty'"; break;
            default:               statusClause = ""; break;
        }

        String sql = "SELECT id AS 'ID', (firstname||' '||lastname) AS 'Name', " +
                     "email AS 'Email', username AS 'Username', work_status AS 'Work Status' " +
                     "FROM tbl_users WHERE type='Employee'" + statusClause;
        if (!kw.isEmpty()) {
            String k = kw.replace("'", "''");
            sql += " AND ((firstname||' '||lastname) LIKE '%" + k + "%' " +
                   "OR email LIKE '%" + k + "%' OR work_status LIKE '%" + k + "%')";
        }
        sql += " ORDER BY work_status ASC, firstname ASC";
        conf.displayData(sql, TableAvailableEmployee);
    }
    ...
    public void loadTable(String keyword) {
        ...
        if (keyword == null || keyword.trim().isEmpty()) {
            sql = "SELECT id AS 'ID', (firstname||' '||lastname) AS 'Name', " +
                  "email AS 'Email', username AS 'Username', work_status AS 'Work Status' " +
                  "FROM tbl_users WHERE type='Employee' ORDER BY work_status ASC, firstname ASC";
        } else {
            String kw = keyword.replace("'", "''");
            sql = "SELECT id AS 'ID', (firstname||' '||lastname) AS 'Name', " +
                  "email AS 'Email', username AS 'Username', work_status AS 'Work Status' " +
                  "FROM tbl_users WHERE type='Employee' AND " +
                  "((firstname||' '||lastname) LIKE '%" + kw + "%' " +
                  "OR email LIKE '%" + kw + "%' OR work_status LIKE '%" + kw + "%') " +
                  "ORDER BY work_status ASC, firstname ASC";
        }
        conf.displayData(sql, TableAvailableEmployee);
    }
    ...
    private void initComponents() {
        ...
        AvailableCleanersheader = new javax.swing.JLabel();
        ...
        AvailableCleanersheader.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        AvailableCleanersheader.setForeground(new java.awt.Color(255, 255, 255));
        AvailableCleanersheader.setText("Available Employee");
        jPanel1.add(AvailableCleanersheader, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 210, 50));
        ...
        skyblue.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 255, 255), new java.awt.Color(0, 255, 255), null, null));
        ...
        skyblue.add(available, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 70, 30));

        availablenum.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        availablenum.setForeground(new java.awt.Color(0, 255, 255));
        availablenum.setText("0");
        skyblue.add(availablenum, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 40, 30));
        ...
        jPanel4.add(searchfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 90, 250, 20));
        ...
        busy.setText("Busy");
        yellow.add(busy, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 0, 60, 30));

        busynum.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        busynum.setForeground(new java.awt.Color(255, 204, 102));
        busynum.setText("0");
        yellow.add(busynum, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 50, 30));

        jPanel4.add(yellow, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 80, 120, 30));
        ...
        red.add(offduty, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 60, 30));

        offdutynum.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        offdutynum.setForeground(new java.awt.Color(255, 102, 102));
        offdutynum.setText("0");
        red.add(offdutynum, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 30, 30));

        jPanel4.add(red, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 80, 110, 30));
        ...
        availablecleanersscrollpane.setBackground(new java.awt.Color(29, 45, 61));
        availablecleanersscrollpane.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        availablecleanersscrollpane.setFont(new java.awt.Font("Bahnschrift", 1, 12)); // NOI18N
        ...
        TableAvailableEmployee.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cleaner ID", "Cleaner Name", "Contact No.", "Current Task", "Work Status"
            }
        ) {
    ...
    private javax.swing.JLabel AvailableCleanersheader;
    private javax.swing.JTable TableAvailableEmployee;
    private javax.swing.JLabel available;
    private javax.swing.JScrollPane availablecleanersscrollpane;
